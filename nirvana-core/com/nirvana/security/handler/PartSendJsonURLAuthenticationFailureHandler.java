...
public class PartSendJsonURLAuthenticationFailureHandler implements AuthenticationFailureHandler {
	...
	public PartSendJsonURLAuthenticationFailureHandler() {
	}

	public PartSendJsonURLAuthenticationFailureHandler(String defaultFailureUrl) {
	...
	public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response, AuthenticationException exception) throws IOException, ServletException {
		...
		if ((decider != null) && (decider.decide(request))) {
			...
			String message = JsonResponseBean.getErrorResponse(ErrorCode.AUTHENTICATE_FAILURE, exception.getMessage()).toJson();
