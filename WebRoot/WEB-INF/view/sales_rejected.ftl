<@override name="title">查看历史促销信息</@override>
...
<@override name="contain">
        ...
        <div class="center">
        <a href="/Nirvana/backend/web/sales_management/${promotion.id}/rejected">
...
<@override name="script">
	...
	PageClick = function(pageclickednumber) {
                window.location.href = "/Nirvana/backend/web/sales_management/rejected?page="+pageclickednumber;
            };
