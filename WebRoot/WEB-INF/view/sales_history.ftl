...
<@override name="contain">
        ...
        <div class="center">
        <a href="/Nirvana/backend/web/sales_management/${promotion.id}/detail">
...
<@override name="script">
	...
	PageClick = function(pageclickednumber) {
                window.location.href = "/Nirvana/backend/web/sales_management/history?page="+pageclickednumber;
            };
