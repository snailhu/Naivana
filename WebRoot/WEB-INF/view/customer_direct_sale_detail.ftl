...
<@override name="link">
    <script src="/Nirvana/static/js/direct_sales_detail.js" type="text/javascript"></script>
            ...
            <div class="container">
                ...
                <div class="contain" style="border: 1px solid #0066b3;">
                    ...
                    <div class="input-item downline-blue-1">
                        <div class="suffix-inline" style="width: 50%;vertical-align: top">
                            <div class="user-input-group">
                                <span class="suffix-inline user-input-title">直营店编号</span>
                                <input type="text" id="code" value="${dealer.codeInERP}" readonly="true">
                            </div>
                            <div class="user-input-group">
                                <span class="suffix-inline user-input-title">大区</span>
                                <input type="text" id="bigArea" value="${dealer.directorArea.name}" readonly="true">
                            </div>
                            <div class="user-input-group">
                                <span class="suffix-inline user-input-title">渠道</span>
                                <!--<select id="channelSelectId"><#list channels as channel><option data-id="${channel.id}">${channel.content}</option></#list></select>-->
                                <input type="text" id="channel" value="${dealer.channel.description}" readonly="true">
                            </div>
                            <div class="user-input-group">
                                <span class="suffix-inline user-input-title">邮编</span>
                                <input type="text" id="postalCode" value="${dealer.storefrontInfo.postalCode}" readonly="true">
                            </div>
                            <div class="user-input-group">
                                <span class="suffix-inline user-input-title">传真号</span>
                                <input type="text" id="faxNum" value="${dealer.storefrontInfo.faxNum}" readonly="true">
                            </div>
                            <div class="user-input-group">
                               ...
                               <div class="user-input-group">
                                <span class="suffix-inline user-input-title">关闭直营店</span>
                        ...
                        <div class="suffix-inline" style="width: 49%">
                            <div class="user-input-group">
                               <span class="suffix-inline user-input-title">直营店名称</span>
                                <input type="text" id="dealerName" value="${dealer.storefrontInfo.name}" readonly="true">
                            </div>
                            <div class="user-input-group">
                                <span class="suffix-inline user-input-title">联系人</span>
                                <input type="text" id="manager" value="${dealer.storefrontInfo.manager}" readonly="true">
                            </div>
                             <div class="user-input-group">
                                <span class="suffix-inline user-input-title">渠道描述</span>
                                <input type="text" readonly="true" value="${dealer.channel.description}">
                            </div>
                            <div class="user-input-group">
                                <span class="suffix-inline user-input-title">地址</span>
                                <input type="text" id="addrDetail" value="${dealer.storefrontInfo.businessAddr}" readonly="true">
                            </div>
                           
                            <div class="user-input-group">
                                <span class="suffix-inline user-input-title">电话手机</span>
                                <input type="text" id="phoneNum" value="${dealer.storefrontInfo.contactValue}" readonly="true">
                            </div>
                            <div class="user-input-group">
                                <span class="suffix-inline user-input-title">Email</span>
                                <input type="text" id="email" value="${dealer.storefrontInfo.email}" readonly="true">
                            </div>
                            <div class="user-input-group">
